        ...
        public static void Configure(ContainerBuilder builder)
        {
            ...
            if (isDevelopmentOrTesting)
            {
                ...
                builder.RegisterAssemblyTypes(assemblyDomain)
                    .Where(t => t.Namespace.EndsWith(nameof(Domain.Models.Messaging)))
                ...
                builder.RegisterAssemblyTypes(assemblyInfraData)
                    .Where(t => t.Namespace.EndsWith(nameof(Data.Repositories)))
                    .AsImplementedInterfaces();
                ...
                builder.RegisterAssemblyTypes(assemblyApplication)
                    .Where(t => t.Namespace.EndsWith(nameof(Application.Services)))
                    .AsImplementedInterfaces();
